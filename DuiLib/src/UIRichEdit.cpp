...
void CRichEditUI::SetTipText(LPCTSTR pstrTip)
{
    m_sTipText = pstrTip;
...
CDuiString CRichEditUI::GetTipText() const
{
...
#ifdef _USEIMM
	else if (uMsg == WM_IME_COMPOSITION)//2021-09-08 zm 解决微软输入法位置异常的问题
	{ 
