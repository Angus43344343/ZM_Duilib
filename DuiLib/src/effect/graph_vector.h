...
public:
    ...
    {
        return ((((m_vector[0] - v.m_vector[0]) < dConst_MinPrecision &&
                  (m_vector[0] - v.m_vector[0]) > -dConst_MinPrecision) ||
                 ((m_vector[1] - v.m_vector[1]) < dConst_MinPrecision &&
                  (m_vector[1] - v.m_vector[1]) > -dConst_MinPrecision) ||
                 ((m_vector[2] - v.m_vector[2]) < dConst_MinPrecision &&
                  (m_vector[2] - v.m_vector[2]) > -dConst_MinPrecision))
                ? false : true);
    }
