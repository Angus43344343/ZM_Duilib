...
public:
    ...
    bool InitMatrix(const WarpRect &_warpRect, const CdRect &_rectSrc)
    {
        ...
        real delta = (warpRect.topRight.x - warpRect.bottomRight.x) * (warpRect.bottomLeft.y - warpRect.topRight.y)
                     - (warpRect.topRight.y - warpRect.bottomRight.y) * (warpRect.bottomLeft.x - warpRect.topRight.x);
        ...
        {
            k2 = ((warpRect.topLeft.x - warpRect.bottomRight.x) * (warpRect.bottomLeft.y - warpRect.topLeft.y) -
                  (warpRect.bottomLeft.x - warpRect.topLeft.x) * (warpRect.topLeft.y - warpRect.bottomRight.y)) / delta;
            k3 = ((warpRect.topLeft.x - warpRect.topRight.x) * (warpRect.bottomLeft.y - warpRect.topRight.y) -
                  (warpRect.bottomLeft.x - warpRect.topRight.x) * (warpRect.topLeft.y - warpRect.topRight.y)) / delta;
            k4 = ((warpRect.topRight.x - warpRect.bottomRight.x) * (warpRect.topLeft.y - warpRect.topRight.y) -
                  (warpRect.topLeft.x - warpRect.topRight.x) * (warpRect.topRight.y - warpRect.bottomRight.y)) / delta;
        }
        ...
        m_warpMatrix[0][2] = warpRect.topLeft.x - (m_warpMatrix[0][0] * rectSrc.left + m_warpMatrix[0][1] *
                                                   rectSrc.top);
        m_warpMatrix[1][2] = warpRect.topLeft.y - (m_warpMatrix[1][0] * rectSrc.left + m_warpMatrix[1][1] *
                                                   rectSrc.top);
    ...
    void WarpPointBack(CdPoint &point)const
    {
        ...
        k = (real)((m_warpMatrix[2][0] * point.x - m_warpMatrix[0][0]) *
                   (m_warpMatrix[2][1] * point.y - m_warpMatrix[1][1]) -
                   (m_warpMatrix[2][0] * point.y - m_warpMatrix[1][0]) *
                   (m_warpMatrix[2][1] * point.x - m_warpMatrix[0][1]));
        ...
        x = (real)((m_warpMatrix[0][2] - m_warpMatrix[2][2] * point.x) *
                   (m_warpMatrix[2][1] * point.y - m_warpMatrix[1][1]) -
                   (m_warpMatrix[1][2] - m_warpMatrix[2][2] * point.y) *
                   (m_warpMatrix[2][1] * point.x - m_warpMatrix[0][1]));

        y = (real)((m_warpMatrix[2][0] * point.x - m_warpMatrix[0][0]) *
                   (m_warpMatrix[1][2] - m_warpMatrix[2][2] * point.y) -
                   (m_warpMatrix[2][0] * point.y - m_warpMatrix[1][0]) *
                   (m_warpMatrix[0][2] - m_warpMatrix[2][2] * point.x));
    ...
    void WarpPointBack(std::vector<CdPoint> &arrPointWarp)const
    {
        ...
        for (it = arrPointWarp.begin(); it != arrPointWarp.end(); it++)
        {
            k = (real)((m_warpMatrix[2][0] * it->x - m_warpMatrix[0][0]) *
                       (m_warpMatrix[2][1] * it->y - m_warpMatrix[1][1]) -
                       (m_warpMatrix[2][0] * it->y - m_warpMatrix[1][0]) *
                       (m_warpMatrix[2][1] * it->x - m_warpMatrix[0][1]));
            ...
            x = (real)((m_warpMatrix[0][2] - m_warpMatrix[2][2] * it->x) *
                       (m_warpMatrix[2][1] * it->y - m_warpMatrix[1][1]) -
                       (m_warpMatrix[1][2] - m_warpMatrix[2][2] * it->y) *
                       (m_warpMatrix[2][1] * it->x - m_warpMatrix[0][1]));
            y = (real)((m_warpMatrix[2][0] * it->x - m_warpMatrix[0][0]) *
                       (m_warpMatrix[1][2] - m_warpMatrix[2][2] * it->y) -
                       (m_warpMatrix[2][0] * it->y - m_warpMatrix[1][0]) *
                       (m_warpMatrix[0][2] - m_warpMatrix[2][2] * it->x));
            it->x = x / k;
            it->y = y / k;
        }
    ...
    void ComputeIntWarpBackMatrix()
    {
        ...
        CMatrix mtxTemp(m_warpMatrix[2][2]*m_warpMatrix[1][1] - m_warpMatrix[1][2]*m_warpMatrix[2][1],
                        m_warpMatrix[2][0]*m_warpMatrix[1][2] - m_warpMatrix[2][2]*m_warpMatrix[1][0],
                        m_warpMatrix[2][1]*m_warpMatrix[1][0] - m_warpMatrix[2][0]*m_warpMatrix[1][1], 0

                        , m_warpMatrix[2][1]*m_warpMatrix[0][2] - m_warpMatrix[2][2]*m_warpMatrix[0][1],
                        m_warpMatrix[2][2]*m_warpMatrix[0][0] - m_warpMatrix[2][0]*m_warpMatrix[0][2],
                        m_warpMatrix[2][0]*m_warpMatrix[0][1] - m_warpMatrix[0][0]*m_warpMatrix[2][1], 0
                        , 0, 0, 0, 0
                        , m_warpMatrix[0][1]*m_warpMatrix[1][2] - m_warpMatrix[0][2]*m_warpMatrix[1][1],
                        m_warpMatrix[1][0]*m_warpMatrix[0][2] - m_warpMatrix[0][0]*m_warpMatrix[1][2],
                        m_warpMatrix[0][0]*m_warpMatrix[1][1] - m_warpMatrix[1][0]*m_warpMatrix[0][1], 0);
