...
//              ze      - pointer to a ZIPENTRYA (if ANSI) or ZIPENTRYW struct
//                        (if Unicode)
//
...
// ZIPENTRYA ze; GetZipItem(hz,-1,&ze); int numitems=ze.index;
...
// ZIPENTRYA ze; int i; FindZipItem(hz,"file.dat",&i,&ze);
...
// for (int i=0; ; i++)
// { ZIPENTRYA ze; ZRESULT res = GetZipItem(hz,i,&ze);
